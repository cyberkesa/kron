  ...
  <div>
    <template v-if="stockAvailabilityStatus == 'IN_STOCK'">
      ...
      <div v-else class="flex justify-center items-center">
        ...
        >
          <path
            d="M17.999 12.7505C18.3615 12.7505 18.6553 13.0443 18.6553 13.4067V17.3436L22.5928 17.3442C22.9552 17.3442 23.249 17.6381 23.249 18.0005C23.249 18.3629 22.9552 18.6567 22.5928 18.6567H18.6553V22.5942C18.6553 22.9567 18.3615 23.2505 17.999 23.2505C17.6366 23.2505 17.3428 22.9567 17.3428 22.5942V18.6567H13.4053C13.0428 18.6567 12.749 18.3629 12.749 18.0005C12.749 17.6381 13.0428 17.3442 13.4053 17.3442H17.3428V13.4067C17.3428 13.0443 17.6366 12.7505 17.999 12.7505Z"
            fill="#CC5654"
            stroke="#CC5654"
            stroke-width="1.125"
          />
    ...
    <template v-else>
      <span v-if="stockAvailabilityStatus == 'OUT_OF_STOCK'"
        >Нет в наличии</span
      >
      <span v-if="stockAvailabilityStatus == 'IN_STOCK_SOON'"
        >Скоро поступление</span
      >
    </template>
  </div>
</template>
